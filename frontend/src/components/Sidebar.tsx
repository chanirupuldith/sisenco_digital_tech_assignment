...
const Sidebar: React.FC = () => {
    ...
    const menuItems = [
        ...
        { name: 'Transactions', icon: <ArrowUpRight size={20} />, path: '/transactions' },
    ...
    return (
        <aside className="w-64 h-screen bg-slate-200 border-r border-slate-100 flex flex-col sticky top-0">
            <div className="p-6 flex items-center gap-3">
                ...
                <span className="text-xl font-extrabold text-slate-900 tracking-tight">FinTrack</span>
            </div>
            ...
            <div className="p-4 border-t border-slate-300 bg-slate-200">
                <div className="flex items-center gap-3 p-2 mb-3">
                    ...
                    <div className="overflow-hidden">
                        <p className="text-xs font-bold text-slate-900 truncate">{auth?.user.username}</p>
